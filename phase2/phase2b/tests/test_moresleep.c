...
int Sleeper(void *arg) {
    ...
    if (seconds >= 0)
        ...
        assert(rc == P2_INVALID_SECONDS);
    Sys_GetTimeOfDay(&end);
    USLOSS_Console("38:%d start:%d end:%d\n", seconds, start, end);
