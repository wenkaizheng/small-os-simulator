...
Reader(void *arg)
{
    ...
    rc = Sys_Spawn("Writer0", Writer, (void *) sid, USLOSS_MIN_STACK * 2, 4, &pid);
    assert(rc == P1_SUCCESS);

    rc = Sys_Spawn("Writer1", Writer, (void *) sid, USLOSS_MIN_STACK * 2, 4, &pid);
    assert(rc == P1_SUCCESS);

    rc = Sys_Spawn("Writer2", Writer, (void *) 100, USLOSS_MIN_STACK * 2, 4, &pid);
...
P4_Startup(void *arg)
{
  //  int     i;
    ...
    rc = Sys_Wait(&pid, &child);
    USLOSS_Console("call  free in here\n");
    assert(rc == P1_SUCCESS);
