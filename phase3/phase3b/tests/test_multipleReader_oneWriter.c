...
Writer(void *arg)
{
    ...
    rc = Sys_Spawn("Reader0", Reader, (void *) sid, USLOSS_MIN_STACK * 2, 4, &pid);
    assert(rc == P1_SUCCESS);

    rc = Sys_Spawn("Reader1", Reader, (void *) sid, USLOSS_MIN_STACK * 2, 4, &pid);
    assert(rc == P1_SUCCESS);

    rc = Sys_Spawn("Reader2", Reader, (void *) sid, USLOSS_MIN_STACK * 2, 4, &pid);
    assert(rc == P1_SUCCESS);
