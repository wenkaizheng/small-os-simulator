...
CFLAGS += -Wall -g -std=gnu99 -Werror --coverage -DPHASE=$(PHASE_UPPER) -DVERSION=$(VERSION) -DDATE="`date`"
#CFLAGS += -DDEBUG
...
clean:
	rm -f $(COBJS) $(TARGET) $(TOBJS) $(TESTS) $(DEPS) $(TDEPS) $(TVS) $(STUBS) $(GCNO) $(GCDA) *.out tests/*.out tests/*.err
